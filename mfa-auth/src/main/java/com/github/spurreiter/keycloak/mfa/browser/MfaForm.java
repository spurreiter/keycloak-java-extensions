...
public class MfaForm {
    ...
    public void action(AuthenticationFlowContext context) {
        ...
        // failed -> exit
        if (doExit) {
            logger.infof("authentication failed. requestid=%s realm=%s username=%s error=%s", xRequestId,
    ...
    public void requestChallenge(AuthenticationFlowContext context) {
        String error = null;
    ...
    public Response createChallengeFormResponse(AuthenticationFlowContext context, String error) {
