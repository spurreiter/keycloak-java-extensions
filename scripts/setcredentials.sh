...
_auth
_createUser alice alice "-s firstName=Alice -s lastName=Anders -s email=alice@local.my -s emailVerified=false -s attributes.otpauth=force -s attributes.phoneNumberVerified=false -s attributes.phoneNumber=\"+1800800800\"" 
_createUser bob bob
